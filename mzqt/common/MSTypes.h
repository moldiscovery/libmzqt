...
#ifndef MZQT_MSTYPES_H_
#define MZQT_MSTYPES_H_
...
namespace mzqt {
    ...
    typedef enum {
        MANUFACTURER_UNDEF = 0, THERMO, // specific incarnation unknown
        THERMO_SCIENTIFIC,
        THERMO_FINNIGAN,
        WATERS,
        ABI_SCIEX,
    ...
    typedef enum {
        ...
        TSQ_QUANTUM_ACCESS,
        TSQ_QUANTUM,
        TSQ_VANTAGE_STANDARD,

        // thermo finnigan
        LCQ, // TODO: lookup to see which thermo incarnation this really is
        LCQ_ADVANTAGE,
        LCQ_CLASSIC,
        LCQ_DECA,
        LCQ_DECA_XP,
    ...
    typedef enum {
        POLARITY_UNDEF = 0, POSITIVE, NEGATIVE, ANY
    // does this really exist? from original ReAdW
    } MSPolarityType;

    // rename?
    typedef enum {
        SCANDATA_UNDEF = 0, CENTROID, PROFILE,
    } MSScanDataType;
    ...
    typedef enum {
        ...
        SCAN_UV, //Diode array data (not MS but sometimes mixed by the provider api)
        ...
        // added for Waters
        CALIBRATION_SCAN, // Calibration reference
    ...
    typedef enum {
        ...
        // added for Waters
        MASSLYNX_COORDINATE_FUNCTION,
        MASSLYNX_COORDINATE_PROCESS,
        MASSLYNX_COORDINATE_SCAN,
        MASSLYNX_COORDINATE_TRANSITION,
        ...
        // added for Agilent MassHunter
        MHDAC_COORDINATE_NATIVESCANNUM
