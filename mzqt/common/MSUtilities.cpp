...
string convertToURI(const std::string& filename, const std::string& hostname)
{
    string output = "file://";
...
namespace {
    //necessary because std C++ take a int as argument
...
{
    string upper = str;
    transform(upper.begin(), upper.end(), upper.begin(), toUpperC);
    return upper;
}
std::string toLower(const std::string& str)
{
    string lower = str;
    transform(lower.begin(), lower.end(), lower.begin(), toLowerC);
    return lower;
}
